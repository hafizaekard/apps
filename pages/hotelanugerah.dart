...
class HotelAnugerah extends StatefulWidget {
  const HotelAnugerah({super.key});

  @override
  State<HotelAnugerah> createState() => _HotelAnugerahState();
}

class _HotelAnugerahState extends State<HotelAnugerah> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Hotel Anugerah Palembang merupakan hotel yang terletak di Komp. Hotel Anugerah, Jl. Jend. Sudirman, No.149, Sungai Pangeran, Kec. Ilir Timur I, Kota Palembang, Sumatera Selatan. Dengan desain arsitektur yang bergaya, hotel ini menawarkan 58 kamar,  ruang rapat, resepsionis 24 jam, dan WiFi gratis.',
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/meetingroomsanugerah.png',
                          height: 200,
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/allroomsanugerah.png',
                          height: 390,
                          width: double.infinity,
                          fit: BoxFit.cover,
                        ),
