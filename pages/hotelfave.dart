...
class HotelFave extends StatefulWidget {
  const HotelFave({super.key});

  @override
  State<HotelFave> createState() => _HotelFaveState();
}

class _HotelFaveState extends State<HotelFave> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Favehotel Palembang merupakan hotel yang terletak di Jl. Basuki Rahmat, No.1681, Kota Palembang, Sumatra Selatan. Dengan desain arsitektur yang bergaya, hotel ini menawarkan 100 kamar, ruang rapat, resepsionis 24 jam, dan WiFi gratis.',
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/meetingroomsfave.jpeg',
                          height: 200,
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/allroomsfave.png',
                          height: 390,
                          width: double.infinity,
                          fit: BoxFit.cover,
                        ),
                       ...
                       Padding(
                        padding: EdgeInsets.all(7),
                         child: Text(
                            'Terdapat 3 tipe kamar, yaitu Executive Suite, Deluxe Premiere, dan Superior',
                            textAlign: TextAlign.center,
                            style: blackTextStyle.copyWith(
                              fontSize: 15,
                              fontWeight: semiBold,
