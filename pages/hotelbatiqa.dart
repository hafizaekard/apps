...
class HotelBatiqa extends StatefulWidget {
  const HotelBatiqa({super.key});

  @override
  State<HotelBatiqa> createState() => _HotelBatiqaState();
}

class _HotelBatiqaState extends State<HotelBatiqa> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Batiqa Hotel Palembang merupakan hotel yang terletak di Jl. Kapten A. Rivai, No.219, 26 Ilir D. I, Kec. Ilir Barat I, Kota Palembang, Sumatera Selatan. Dengan desain arsitektur yang bergaya, hotel ini menawarkan 160 kamar, ruang rapat, resepsionis 24 jam, dan WiFi gratis.',
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/meetingroomsbatiqa.jpg',
                          height: 200,
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/allroomsbatiqa.png',
                          height: 390,
                          width: double.infinity,
                          fit: BoxFit.cover,
                        ),
                       ...
                       Padding(
                        padding: EdgeInsets.all(7),
                         child: Text(
                            'Terdapat 3 tipe kamar, yaitu Premiere, Deluxe dan Superior',
                            textAlign: TextAlign.center,
                            style: blackTextStyle.copyWith(
                              fontSize: 15,
                              fontWeight: semiBold,
