...
class HotelRio extends StatefulWidget {
  const HotelRio({super.key});

  @override
  State<HotelRio> createState() => _HotelRioState();
}

class _HotelRioState extends State<HotelRio> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Rio City Palembang merupakan hotel yang terletak di Jl. Lingkaran 1, No.01, 9 Ilir, Kec. Ilir Timur II, Kota Palembang, Sumatera Selatan. Dengan desain arsitektur yang bergaya, hotel ini menawarkan 80 kamar,  ruang rapat, resepsionis 24 jam, dan WiFi gratis.',
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/meetingroomsrio.jpg',
                          height: 200,
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/allroomsrio.png',
                          height: 390,
                          width: double.infinity,
                          fit: BoxFit.cover,
                        ),
