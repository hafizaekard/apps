...
class HotelSalatin extends StatefulWidget {
  const HotelSalatin({super.key});

  @override
  State<HotelSalatin> createState() => _HotelSalatinState();
}

class _HotelSalatinState extends State<HotelSalatin> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Salatin Hotel Palembang merupakan hotel yang terletak di Jl. Sultan M. Mansyur, No.7, Bukit Lama, Kec. Ilir Barat I, Kota Palembang, Sumatera Selatan. Dengan desain arsitektur yang bergaya, hotel ini menawarkan 85 kamar, ruang rapat, resepsionis 24 jam, dan WiFi gratis.',
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/meetingroomssalatin.jpg',
                          height: 200,
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/allroomssalatin.png',
                          height: 390,
                          width: double.infinity,
                          fit: BoxFit.cover,
                        ),
                       ...
                       Padding(
                        padding: EdgeInsets.only(left: 7, right: 7, top: 17),
                         child: Text(
                            'Terdapat 2 tipe kamar, yaitu Deluxe, dan Family',
                            textAlign: TextAlign.center,
                            style: blackTextStyle.copyWith(
                              fontSize: 15,
                              fontWeight: semiBold,
