...
class HotelBeston extends StatefulWidget {
  const HotelBeston({super.key});

  @override
  State<HotelBeston> createState() => _HotelBestonState();
}

class _HotelBestonState extends State<HotelBeston> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Beston Hotel Palembang merupakan hotel yang terletak di Jl. Jend. Sudirman, No.57, 20 Ilir D. I, Kec. Ilir Timur I, Kota Palembang, Sumatera Selatan. Dengan desain arsitektur yang bergaya, hotel ini menawarkan 138 kamar, ruang rapat, resepsionis 24 jam, dan WiFi gratis.',
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/meetingroomsbeston.jpg',
                          height: 200,
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'lib/assets/pic/allroomsbeston.png',
                          height: 390,
                          width: double.infinity,
                          fit: BoxFit.cover,
                        ),
                       ...
                       Padding(
                        padding: EdgeInsets.only(left: 7, right: 7, top: 17),
                         child: Text(
                            'Terdapat 2 tipe kamar, yaitu Premium dan Deluxe',
                            textAlign: TextAlign.center,
                            style: blackTextStyle.copyWith(
                              fontSize: 15,
                              fontWeight: semiBold,
